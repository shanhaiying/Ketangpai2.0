...
urlpatterns = [
	...
	url(r'^$',view.welcome,name = 'welcome'),
	
	
	url(r'band_register/',bandurl.band_register,name = 'band_register'),
	url(r'band_login/',bandurl.band_login,name = 'login'),\
	url(r'band_save_profile/',bandurl.band_save_profile,name = 'band_save_profile'),
	url(r'band_get_profile/',bandurl.band_get_profile,name = 'band_get_profile'),
]
